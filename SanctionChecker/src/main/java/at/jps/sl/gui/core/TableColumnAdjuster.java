...
/*
 * Class to manage the widths of colunmns in a table. Various properties control how the width of the column is calculated. Another property controls whether column width calculation should be
 * dynamic. Finally, various Actions will be added to the table to allow the user to customize the functionality. This class was designed to be used with tables that use an auto resize mode of
 * AUTO_RESIZE_OFF. With all other modes you are constrained as the width of the columns must fit inside the table. So if you increase one column, one or more of the other columns must decrease.
...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
     ...
     */
    private void installColumnAction(final boolean isSelectedColumn, final boolean isAdjust, final String key, final String keyStroke) {
     ...
     */
    private void installToggleAction(final boolean isToggleDynamic, final boolean isToggleLarger, final String key, final String keyStroke) {
    ...
    class ColumnAction extends AbstractAction {
         ...
         *
         */
        private static final long serialVersionUID = 4748853739427947805L;
    ...
    class ToggleAction extends AbstractAction {
         ...
         *
         */
        private static final long serialVersionUID = 2840083397808067645L;
