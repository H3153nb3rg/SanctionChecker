...
public abstract class SanctionPostNoHitWorker extends PostNoHitWorker {
    ...
    public void handleMessage(AnalysisResult message) {
        ...
        for (HitResult slhr : message.getHitList()) {
            ...
            msgFieldContent = messageContent.getFieldsAndValues().get(((SanctionListHitResult) slhr).getHitField());
