...
/**
 * Thrown to indicate that an attempt has been made to convert a string to a {@link fr.marcwrobel.jbanking.creditor.CreditorIdentifier}, but that the string does not have the appropriate format.
 *
