 ...
 */
package at.jps.sanction.core.banking.swift;
 ...
 * <p>
 * This class internally uses a {@link java.util.regex.Pattern} by transforming the SWIFT expression to a traditional regular expression. As a result the
 * SwiftPattern API is similar to the {@link java.util.regex.Pattern Pattern API}.
 * </p>
 * <p>
...
public final class SwiftPattern {
    ...
    private SwiftPattern(final String expression, final Pattern equivalentJavaPattern) {
     ...
     */
    public static SwiftPattern compile(final String expression) {
        if (expression == null) {
    ...
    private static String toRegex(final String expression) {
        final Matcher matcher = SWIFT_FORMAT_GROUPS_PATTERN.matcher(expression);
    ...
    private static String transform(final String simpleExpression) {
        final int length = simpleExpression.length();
        ...
        final boolean strict = simpleExpression.charAt(simpleExpression.length() - 2) == '!';
        final String maxOccurence = simpleExpression.substring(0, length - (strict ? 2 : 1));
    ...
    public boolean equals(final Object o) {
        ...
        final SwiftPattern that = (SwiftPattern) o;
