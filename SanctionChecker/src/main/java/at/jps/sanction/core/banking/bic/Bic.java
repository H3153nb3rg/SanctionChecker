...
public final class Bic {
     ...
     *             if the given BIC8 or BIC11 string does not match {@link #BIC_REGEX} or if the given BIC8 or BIC11 country code is not known in {@link at.jps.sanction.core.banking.IsoCountry}
     */
     ...
     * <p>
     * To be equals to this one an other object must be a Bic and the BICs normalized form (see {@link #toString()}) must be equal.
     * </p>
     *
     * @param o
