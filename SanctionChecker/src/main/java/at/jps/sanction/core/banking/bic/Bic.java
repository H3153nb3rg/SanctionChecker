...
public final class Bic {
     ...
     * @throws BicFormatException       if the given BIC8 or BIC11 string does not match {@link #BIC_REGEX} or if the given BIC8 or BIC11 country code is not known in {@link at.jps.sanction.core.banking.IsoCountry}
     */
